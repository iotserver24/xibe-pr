...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-gray-900 dark:bg-gray-900 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-gray-100 dark:text-gray-100 max-w-4xl">
          Our Development Journey
        </h2>
        <p className="text-gray-400 dark:text-gray-400 text-sm md:text-base max-w-sm">
          The evolution of xibe-pr1 from concept to production-ready AI platform.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gray-800 dark:bg-gray-800 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-gray-600 dark:bg-gray-600 border border-gray-500 dark:border-gray-500 p-2" />
              </div>
